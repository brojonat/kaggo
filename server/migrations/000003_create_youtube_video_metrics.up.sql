...
CREATE INDEX IF NOT EXISTS youtube_video_likes_title ON youtube_video_likes (title, ts);
...
CREATE INDEX IF NOT EXISTS youtube_video_comments_title ON youtube_video_comments (title, ts);
